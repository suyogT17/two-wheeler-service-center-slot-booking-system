                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="tabledata">
                                                              <thead>
                                                                                         <tr>
																								...
																								<th style="background-color: #0FA0A7;">Vehicle Number</th>
																							    <th style="background-color: #0FA0A7;">Chassis No.</th>
																								<th style="background-color: #0FA0A7;">Purchase Date</th>
																								<th style="background-color: #0FA0A7;">Registrationr</th>
																								<!-- <th>effectiveDate</th> -->
																									<!-- <th>endDate</th> -->
                                                                                  ...
                                                                                  <c:forEach items="${vehicle}" var="v">	
                                                                                  	<tr>
																								...
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.vehicleName } </td>
																							     <td style="background-color: #0FA0A10; color:#3A2925;">${v.number} </td>
																							    <td style="background-color: #0FA0A10; color:#3A2925;">${v.chassisNo} </td>
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.purchaseDate }</td>
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.regiDate }</td>
																								<!-- <th>effectiveDate</th> -->
																									<!-- <th>endDate</th> -->
