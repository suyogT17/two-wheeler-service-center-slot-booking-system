                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="tabledata">
                                                              <thead>
                                                                                         <tr>
																								...
																								<th style="background-color: #0FA0A7;">Manager Name</th>
																								<th style="background-color: #0FA0A7;">Email</th>
																							    <th style="background-color: #0FA0A7;">Contact No.</th>
																								
																								<th style="background-color: #0FA0A7;">City</th>
																								<!-- <th>effectiveDate</th> -->
																									<!-- <th>endDate</th> -->
                                                                                  ...
                                                                                  <c:forEach items="${branch}" var="v">	
                                                                                  	<tr>
                                                                                                
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.branchName } </td>
																							     <td style="background-color: #0FA0A10; color:#3A2925;">${v.managerName} </td>
																							    <td style="background-color: #0FA0A10; color:#3A2925;">${v.emailId} </td>
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.contactNo}</td>
																								<td style="background-color: #0FA0A10; color:#3A2925;">${v.city }</td>
